...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _application_view = __webpack_require__(298);
	...
	var game = new _game2.default({
	  squares: [{ contents: "", xAxis: 0, yAxis: 0 }, { contents: "", xAxis: 0, yAxis: 1 }, { contents: "", xAxis: 0, yAxis: 2 }, { contents: "", xAxis: 1, yAxis: 0 }, { contents: "", xAxis: 1, yAxis: 1 }, { contents: "", xAxis: 1, yAxis: 2 }, { contents: "", xAxis: 2, yAxis: 0 }, { contents: "", xAxis: 2, yAxis: 1 }, { contents: "", xAxis: 2, yAxis: 2 }]
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _backbone = __webpack_require__(299);
	...
	var _board_view = __webpack_require__(305);
	...
	var _api_game_view = __webpack_require__(307);

	var _api_game_view2 = _interopRequireDefault(_api_game_view);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var ApplicationView = _backbone2.default.View.extend({
	  initialize: function initialize() {
	    this.winnerModalTemplate = _underscore2.default.template((0, _jquery2.default)('#winner-modal-template').html());
	    this.formModalTemplate = _underscore2.default.template((0, _jquery2.default)('#form-modal-template').html());
	    this.turnModalTemplate = _underscore2.default.template((0, _jquery2.default)('#turn-modal-template').html());
	  },

	  render: function render() {
	    // console.log('rendering ApplicationView');
	    var board = new _board_view2.default({
	      collection: this.model.board,
	      el: this.$("#board-holder")
	    });
	    (0, _jquery2.default)("#modal").html(this.formModalTemplate());
	  ...
	  getNames: function getNames(event) {
	    var players = {
	  ...
	  gameOver: function gameOver(event) {
	    ...
	    (0, _jquery2.default)('#modal').html(this.winnerModalTemplate({ winStatus: winner }));
	  },

	  clearOldGame: function clearOldGame(event) {
	  ...
	  nameInModal: function nameInModal(event) {
	    ...
	    (0, _jquery2.default)('#modal').html(this.turnModalTemplate({ turn: nextPlayer + "'s turn!" }));
	  },

	  clearForm: function clearForm(event) {
	    (0, _jquery2.default)('input[name="playerX"]').val("");
	    (0, _jquery2.default)('input[name="playerO"]').val("");
	  },

	  saveGameToAPI: function saveGameToAPI(game) {
	    game.save();
	  },

	  getAPIHistory: function getAPIHistory() {
	    this.model.fetch().done(function (list) {
	      for (var i = 0; i < list.length; i++) {
	        var newAPIGameView = new _api_game_view2.default({ model: list[i] });
	        newAPIGameView.render();
	      }
	    });
	    (0, _jquery2.default)(".btn-fetch").hide();
	    (0, _jquery2.default)(".btn-clear-hist").show();
	  },

	  clearAPIHistory: function clearAPIHistory() {
	    (0, _jquery2.default)("li").remove();
	    (0, _jquery2.default)(".btn-clear-hist").hide();
	    (0, _jquery2.default)(".btn-fetch").show();
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(300), __webpack_require__(301), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _board = __webpack_require__(303);
	...
	var Game = _backbone2.default.Model.extend({
	  ...
	  toJSON: function toJSON() {
	    ...
	    var outcome = this.board.status === "tie!" ? "draw" : this.board.status[0];
	    var x = this.get("playerX");
	    var o = this.get("playerO");
	    var boardForAPI = [];
	  ...
	  initialize: function initialize(options) {
	    ...
	    this.board = new _board2.default(options.squares);
	  },

	  resetBoard: function resetBoard() {
	    var squares = [{ contents: "", xAxis: 0, yAxis: 0 }, { contents: "", xAxis: 0, yAxis: 1 }, { contents: "", xAxis: 0, yAxis: 2 }, { contents: "", xAxis: 1, yAxis: 0 }, { contents: "", xAxis: 1, yAxis: 1 }, { contents: "", xAxis: 1, yAxis: 2 }, { contents: "", xAxis: 2, yAxis: 0 }, { contents: "", xAxis: 2, yAxis: 1 }, { contents: "", xAxis: 2, yAxis: 2 }];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _square = __webpack_require__(304);
	...
	var Board = _backbone2.default.Collection.extend({
	  ...
	  findWinner: function findWinner() {
	    ...
	    var possibleWins = [this.vertical(), this.horizontal(), this.diagonal()];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _square_view = __webpack_require__(306);
	...
	var BoardView = _backbone2.default.View.extend({
	  initialize: function initialize() {
	    this.alertTemplate = _underscore2.default.template((0, _jquery2.default)('#alert-template').html());
	  },

	  render: function render() {
	    // console.log("rendering boardView")
	    var newSquareList = this.$el;
	    // console.log("this is the new square list", newSquareList)
	    newSquareList.empty();

	    this.collection.forEach(function (square) {
	      var newSquare = new _square_view2.default({
	        model: square
	      });
	  ...
	  play: function play(clickedSquare) {
	    var square = clickedSquare.model;
	    ...
	    if (square.get("contents") === "" && board.nextTurn <= 9 && board.status === "pending") {
	      ...
	      (0, _jquery2.default)("#modal").find('.alert').remove();
	      (0, _jquery2.default)("#modal").prepend(this.alertTemplate({ alert: "game over. begin a new game!" }));
	    } else {
	      (0, _jquery2.default)("#modal").find('.alert').remove();
	      (0, _jquery2.default)("#modal").prepend(this.alertTemplate({ alert: "spot full. please pick another!" }));
	    }
	  },

	  incrementTurn: function incrementTurn(board) {
	    if (board.nextTurn <= 9) {
	      board.nextTurn += 1;
	    }
	  },

	  chooseSymbol: function chooseSymbol(nextTurn) {
	    if (nextTurn % 2 === 0) {
	      return "O";
	    } else {
	      return "X";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SquareView = _backbone2.default.View.extend({
	  ...
	  initialize: function initialize() {
	    this.template = _underscore2.default.template((0, _jquery2.default)('#square-template').html());
	  ...
	  selectSquare: function selectSquare() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var APIGameView = _backbone2.default.View.extend({
	  initialize: function initialize(game) {
	    this.element = (0, _jquery2.default)("#API-ref");
	    this.gameTemplate = _underscore2.default.template((0, _jquery2.default)('#api-game-template').html());
	    this.game = new _game2.default(game);
	    //
	    // this.render(game);
	  },
